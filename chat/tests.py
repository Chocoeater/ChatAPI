...
class MessageModelTest(TestCase):
    ...
    def setUp(self):
        self.chat = Chat.objects.create(title="Тестовый чат")
        self.message = Message.objects.create(chat_id=self.chat, text="Тестовое сообщение")
    ...
    def test_message_ordering(self):
        ...
        message2 = Message.objects.create(chat_id=self.chat, text="Другое тестовое сообщение")
